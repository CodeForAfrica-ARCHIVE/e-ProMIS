...
?></title>   
    ...
    <header>
        <div class="sticky-nav">
            ...
            <div id="logo">
                <a id="goUp" href="#" title="e-promis.code4kenya.org"></a>
            </div>
            ...
            <div style="padding-top:18px;"><a href="<?php echo base_url(); ?>charts/" target="_parent" style="color:#ffffff; margin-top:5px; font-size:21px; text-align:justify;" >&nbsp;&nbsp;&nbsp;&nbsp;OTHERS</a></div>
    ...
    <!-- End Header -->
     ...
     <div id="home-slider" class="page"  >
        <div class="container" >
              ...
              <div id="space" align="center" style="padding-top:17%;">
              <h2 align="center" style="font-style: color: #fff;" ></h2>
                <form action="<?php echo base_url();?>#work" method="GET">
                    <input id="search" name="search" type="text" list="" placeholder="enter county name" align="middle" value=""/>
                    <button id="submit"  type="submit" align="middle" onClick="window.location = '<?php echo base_url();?>#work'"  on>Go</button>
                </form>  
              </div>     
          </div>
          </div>
    ...
    <div id="work" class="page"  >
        <div class="container" >
            ...
            <div class="row">
                <div class="span12">
                    <div class="title-page" style="padding-bottom:20px;">
         ...
         <div class="span10" id="wrap">
			...
			<?php foreach ($projects as $project): ?>
				<div style = "background-color:#ffffff; margin-top:65px; width:100%; height:80px;">
					<table>
						<tr>
                        ...
                        <?php if($project->projects > 0):?>
                            ...
                            <?php endfor; ?>
                        <?php else: ?> 
                           <td class="sector" style = "border-spacing:1; border: 4px solid #ffffff; background-color:#ffffff; margin-right:7.02%; margin-left:7.02%; width:20px; height:10.42%; margin-bottom:7.16%;" ></td>
                        <?php endif; ?>
						</tr>
					</table>
				</div>
			...
			<?php foreach ($projects as $project): ?>
				...
				<div align="left" style= "background-color:transparent; margin-top:65px; width:200%; height:80px; ">
				<table>
					<tr>
					<?php if($project->amount == 0):?>
                    <td class="sector" style = "border-spacing:1; border: 4px solid #ffffff; background-color:#ffffff; margin-right:0.8em; width:0.8em; height:80px; margin-bottom:55px;" ></td>
                    <?php endif; ?>
                    <?php if(($project-> amount <= 100000000) && ($project-> amount > 0)) :?>
                    <td class="sector" align="left" style = "border-spacing:1; border: 4px solid #ffffff; background-color:<?php echo $project->color; ?>; margin-right:0.08em;width:0.08em; height:80px; margin-bottom:55px;"></td>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                   	<?php if($project->amount > 7000000000): ?>
                    <?php for($i=1;$i<=65; $i++) : ?>
                    <td class="sector" align="left" style = "border-spacing:1; border: 4px solid #ffffff; background-color:<?php echo $project->color; ?>; width:0.08em; height:80px; margin-bottom:55px;"></td>
                    <?php endfor; ?>
                    <?php endif; ?>
            ...
            <div id="mdg" class="page">
                <div class="container">
					...
					<?php foreach ($mdgs as $mdg):?>
						...
						<div class="mdg" style = "background-color:<?php echo $mdg->color; ?>; width:70%; padding-left:20%; height:<?php echo $mdg->amount/20000000;?>px;"></div>
						<div align="center">
    ...
    <a href="http://disqus.com" class="dsq-brlink">comments powered by <span class="logo-disqus">Disqus</span></a>
            ...
            <p> SUPPORTED BY:<br/>
            <a href="http://wbi.worldbank.org/wbi/open-aid-partnership/" target="_blank"><img src="<?php echo base_url(); ?>img/OpenAid.jpg" /></a><br/><br/>
